...
echo
sleep 2
docker build -t sheikap-docker/karsajobs-ui:latest .
echo
echo  "\e[1;3;33m Mengubah nama image agar sesuai dengan format GitHub Packages \e[0m"
echo
sleep 2
docker tag sheikap-docker/karsajobs-ui:latest ghcr.io/sheikapraya/karsajobs-ui:latest
echo
...
echo
sleep 2
docker push ghcr.io/sheikapraya/karsajobs-ui:latest
echo
echo GOOD JOB
sleep 2
