...
echo
sleep 2
docker build -t sheikap-docker/shipping-service:latest .
echo
echo  "\e[1;3;33m Mengubah nama image agar sesuai dengan format GitHub Packages \e[0m"
echo
sleep 2
docker tag sheikap-docker/shipping-service:latest ghcr.io/sheikapraya/shipping-service:latest
echo
...
echo
sleep 2
docker push ghcr.io/sheikapraya/shipping-service:latest
echo
echo GOOD JOB
sleep 2
